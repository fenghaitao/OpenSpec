...
class ClineSlashCommandConfigurator(SlashCommandConfigurator):
    ...
    # File paths for Cline slash commands
    _FILE_PATHS: Dict[str, str] = {
        "proposal": ".cline/prompts/openspec/proposal.md",
        "apply": ".cline/prompts/openspec/apply.md",
        "archive": ".cline/prompts/openspec/archive.md"
    }
...
Archive a deployed OpenSpec change and update specs."""
    ...
    def get_relative_path(self, command_id: str) -> str:
        """Get the relative path for a Cline slash command."""
        return self._FILE_PATHS[command_id]
    
    def get_frontmatter(self, command_id: str) -> str:
        """Get the frontmatter for a Cline slash command."""
